                ...
                case state.IDLE:
                    {
                        ...
                        if (wanderDelay <= timer && (l_check == DistanceCheck.HAS_REACHED_DESTINATION || l_check == DistanceCheck.PATH_INVALID) || StaticManager.Utility.NavDistanceCheck(Agent) == DistanceCheck.HAS_NO_PATH && l_check != DistanceCheck.NOT_ON_NAV)
                        {
                ...
                case state.ATTACKING:
                    {
                        ...
                        if (character.enemies.Count > 0 && character.enemies[0] == null)
                        {
