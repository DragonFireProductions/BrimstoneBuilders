Shader "Hidden/Alpha"
{
	 Properties
  {
    ...
    _FadeEndDistance ("FadeEndDistance", Float) = 3
  }
  ...
  SubShader
  {
    Pass
    {
      ...
      fixed4 frag (v2f i) : SV_Target
      {
        ...
        if (_Distance < _FadeEndDistance) {
          return fixed4(1, 1, 1, (_Distance - _FadeEndDistance) / (_FadeStartDistance - _FadeEndDistance)); // fading out
        }
		if (_Distance > _FadeEndDistance)
		{
