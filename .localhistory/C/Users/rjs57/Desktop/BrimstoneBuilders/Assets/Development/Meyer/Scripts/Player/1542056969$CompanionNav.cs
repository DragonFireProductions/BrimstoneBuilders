...
public class CompanionNav : BaseNav {
    ...
    public AggressionStates SetAgreesionState
    {
        ...
        set
        {
            ...
            if (aggState == AggressionStates.BERZERK)
            {
            ...
            else if (aggState == AggressionStates.DEFEND)
            {

            }
            else if (aggState == AggressionStates.PASSIVE)
            {

            }
            else if (aggState == AggressionStates.PROVOKED)
            {
