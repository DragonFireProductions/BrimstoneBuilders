...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField]
    TextMeshProUGUI postmessage;
    private string message = "Go forth young warrior, and make your ancestors proud!";
        ...
        if (Input.GetMouseButtonDown(0))
        {
            if (Physics.Raycast(ray, out hit))
            {
                ...
                if (hit.collider.tag == "post")
                {
                    ...
                    {
                        postmessage.text = othermessage;
                    }
                    //showtext = true;
                    //GUI.Label(new Rect(Screen.width / 2, Screen.height / 2, 200, 200), message);
