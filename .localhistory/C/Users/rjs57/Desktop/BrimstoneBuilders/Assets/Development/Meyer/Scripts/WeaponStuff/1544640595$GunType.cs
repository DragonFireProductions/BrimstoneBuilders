...
public class GunType : WeaponObject {
    ...
    protected override void Start( ) {
        ...
        reloading_prog = GetComponent<Sprite>();
    ...
    private IEnumerator Reload( ) {
        reloading = true;
        reloading_prog.uv[0].x += Time.deltaTime;
        reloading_prog.uv[0].y += Time.deltaTime;
        reloading_prog.uv[1].x += Time.deltaTime;
        reloading_prog.uv[1].y += Time.deltaTime;
